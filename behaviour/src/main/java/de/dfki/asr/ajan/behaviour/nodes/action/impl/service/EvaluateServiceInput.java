...
import de.dfki.asr.ajan.behaviour.nodes.action.impl.AbstractEvaluateInput;
...
public class EvaluateServiceInput extends AbstractEvaluateInput {

	public EvaluateServiceInput(final TaskStep next) {
		super(next);
	}
