...
import de.dfki.asr.ajan.behaviour.nodes.action.impl.AbstractEvaluateOutput;
...
public class EvaluateServiceOutput extends AbstractEvaluateOutput {

	public EvaluateServiceOutput(final TaskStep next) {
		super(next);
	}
