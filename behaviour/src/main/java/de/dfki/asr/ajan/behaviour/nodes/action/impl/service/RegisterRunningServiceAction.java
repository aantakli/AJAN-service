...
public class RegisterRunningServiceAction extends AbstractChainStep {

	public RegisterRunningServiceAction(final TaskStep next) {
		super(next);
	}
	...
	public Task.Status execute(final TaskContext context) {
		...
		connection.addProcessId(action.getId().toString());
