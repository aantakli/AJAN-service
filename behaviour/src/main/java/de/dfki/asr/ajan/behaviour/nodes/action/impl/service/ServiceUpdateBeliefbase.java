...
import de.dfki.asr.ajan.behaviour.nodes.action.impl.AbstractUpdateBeliefbase;
...
public class ServiceUpdateBeliefbase extends AbstractUpdateBeliefbase {

	public ServiceUpdateBeliefbase(final TaskStep next) {
		super(next);
	}
