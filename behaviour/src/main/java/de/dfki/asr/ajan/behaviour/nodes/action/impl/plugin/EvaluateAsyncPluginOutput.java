...
public class EvaluateAsyncPluginOutput extends AbstractEvaluateAsyncOutput {

	public EvaluateAsyncPluginOutput(final TaskStep next) {
		super(next);
	}

	@Override
	public AbstractActionDefinition getActionDescription(final TaskContext context) {
		return context.get(PluginActionDefinition.class);
	}
}
