...
import de.dfki.asr.ajan.behaviour.nodes.action.impl.AbstractEvaluateAsyncOutput;

public class EvaluateAsyncServiceOutput extends AbstractEvaluateAsyncOutput {

	public EvaluateAsyncServiceOutput(final TaskStep next) {
		super(next);
	}

	@Override
	public AbstractActionDefinition getActionDescription(final TaskContext context) {
		return context.get(ServiceActionDefinition.class);
	}
}
