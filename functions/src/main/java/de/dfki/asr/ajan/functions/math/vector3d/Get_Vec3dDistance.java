 ...
 * DFKI)
 */
public class Get_Vec3dDistance implements Function {
	...
	public Value evaluate(final ValueFactory valueFactory, final Value... args) throws ValueExprEvaluationException {
		if (args.length != 2) {
			throw new ValueExprEvaluationException(
					"distance function requires" + "exactly 2 argument, got "
							+ args.length);
		}
		...
		return valueFactory.createLiteral(vec1.distance(vec2));
	}
}
