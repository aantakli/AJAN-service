...
@Extension
@Component
@RDFBean("bt-mdp:TransitionModel")
public class TransitionModel extends AbstractTDBLeafTask implements NodeExtension {
    ...
    @RDF("bt-mdp:transition-sample")
    @Getter @Setter
    private BehaviorSelectQuery sample;

    @RDF("bt-mdp:transition-argmax")
    @Getter @Setter
