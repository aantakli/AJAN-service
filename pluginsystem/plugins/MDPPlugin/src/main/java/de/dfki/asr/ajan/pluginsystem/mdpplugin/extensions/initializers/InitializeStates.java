...
@Extension
@Component
@RDFBean("bt-mdp:InitializeStates")
public class InitializeStates extends AbstractTDBLeafTask implements NodeExtension {
    ...
    public NodeStatus executeLeaf() {
        ...
        int responseCode = (int) HTTPHelper.sendPostRequest("http://127.0.0.1:8000/AJAN/pomdp/state/initialize", params, this.getObject().getLogger(),this.getClass(), false);
        if(responseCode >= 300) {
    ...
    public String toString() {
        return "InitializeStates (" + getLabel() + ")";
    }
    ...
    public Resource getType() {
        return vf.createIRI("https://ajan.de/behavior/mdp-ns#InitializeStates");
    }
