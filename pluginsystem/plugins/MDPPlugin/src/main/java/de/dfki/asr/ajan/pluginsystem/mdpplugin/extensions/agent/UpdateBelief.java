...
@Extension
@Component
@RDFBean("bt-mdp:UpdateBelief")
public class UpdateBelief extends AbstractTDBLeafTask implements NodeExtension {
...
//        }
    ...
    public Resource getType() {
        return vf.createIRI("https://ajan.de/behavior/mdp-ns#UpdateBelief");
    }
