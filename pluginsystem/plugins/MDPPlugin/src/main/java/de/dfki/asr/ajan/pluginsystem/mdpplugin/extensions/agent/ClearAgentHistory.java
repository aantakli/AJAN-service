...
@Extension
@Component
@RDFBean("bt-mdp:clearAgentHistory")
public class ClearAgentHistory extends AbstractTDBLeafTask implements NodeExtension {
...
//        }
    ...
    public String toString() {
        return "ClearAgentHistory (" + getLabel() + ")";
    }
    ...
    public Resource getType() {
        return vf.createIRI("https://ajan.de/behavior/mdp-ns#clearAgentHistory");
    }
