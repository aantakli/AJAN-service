...
@Extension
@Component
@RDFBean("bt-mdp:createProblem")
public class CreateProblem extends AbstractTDBLeafTask implements NodeExtension {
    ...
    @RDF("bt-mdp:pomdp-problem-name")
    @Setter
    private String problemName;

    @RDF("bt-mdp:pomdp-problem-data")
    @Getter @Setter
    ...
    public NodeStatus executeLeaf() {
        ...
        if(HTTPHelper.sendPostRequest("http://127.0.0.1:8000/AJAN/pomdp/problem/create",
                params,
    ...
    public Resource getType() {
        return vf.createIRI("https://ajan.de/behavior/mdp-ns#createProblem");
    }
