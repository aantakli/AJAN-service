...
@Extension
@RDFBean("http://www.ajan.de/behavior/python-ns#SetupNode")
public class SetupNode extends AbstractTDBLeafTask implements NodeExtension {
  ...
  public String toString() {
    return "SetupNode (" + label + ")";
  }

  @Override
  public Resource getType() {
    return vf.createIRI("http://www.ajan.de/behavior/python-ns#SetupNode");
  }

  @Override
  public NodeStatus executeLeaf() {
    LOG = this.getObject().getLogger();
    LOG.info(this.getClass(), "================= Test" + getTargetPath() + "=================");
    try {
  ...
  private NodeStatus runPythonScript() throws PythonException {
    LOG.info(this.getClass(), "Executing Python script for SetupNode: " + getTargetPath());
    PythonPlugin.getPowerShellManager().setPath(getTargetPath());
    return new NodeStatus(
