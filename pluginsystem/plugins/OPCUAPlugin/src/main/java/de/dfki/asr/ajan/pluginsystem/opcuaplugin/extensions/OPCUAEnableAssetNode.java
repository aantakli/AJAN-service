...
@Extension
@RDFBean("http://www.ajan.de/behavior/opcua-ns#EnableAssetNode")
public class OPCUAEnableAssetNode extends AbstractTDBLeafTask implements NodeExtension {
  ...
  public String toString() {
    return "OPCUAEnableAssetNode (" + label + ")";
  }

  @Override
  public Resource getType() {
    return vf.createIRI("http://www.ajan.de/behavior/opcua-ns#EnableAssetNode");
  }

  @Override
  public NodeStatus executeLeaf() {
    LOG = this.getObject().getLogger();
    LOG.info(this.getClass(), "================= Test" + isEnabled() + "=================");
    try {
      LOG.info(this.getClass(), "Executing OPCUAEnableAssetNode: " + this);
  ...
  private NodeStatus runPythonScript() throws PythonException {
    LOG.info(this.getClass(), "Executing Python script for assetEnabled: " + isEnabled());
    ...
    inputs.put("call", "enable_asset");
    inputs.put("enable", isEnabled() ? "true" : "false");
