...
public class PrioParallel extends com.badlogic.gdx.ai.btree.BranchTask<AgentTaskInformation> implements NodeExtension, TreeNode {
	 ...
	 * @param policy the policy
	 * @param tasks the children */
	public PrioParallel (Policy policy, Task<AgentTaskInformation>... tasks) {
	 ...
	 * @param policy the policy
	 * @param tasks the children */
	public PrioParallel (Policy policy, Array<Task<AgentTaskInformation>> tasks) {
	 ...
	 * @param orchestrator the orchestrator
	 * @param tasks the children */
	public PrioParallel (Policy policy, Orchestrator orchestrator, Array<Task<AgentTaskInformation>> tasks) {
		super(tasks);
		this.policy = policy;
	...
	protected Task<AgentTaskInformation> copyTo (Task<AgentTaskInformation> task) {
		PrioParallel parallel = (PrioParallel)task;
	...
	public enum Orchestrator {
		...
		Resume() {
			@Override
			public void execute(PrioParallel parallel) {
	...
	public enum Policy {
		...
		Sequence() {
			@Override
			public Boolean onChildSuccess (PrioParallel parallel) {
			...
			@Override
			public Boolean onChildFail (PrioParallel parallel) {
		...
		public abstract Boolean onChildSuccess (PrioParallel parallel);
