...
@RDFBean("bt:IsSucceeding")
public class IsSucceeding extends AlwaysSucceed<AgentTaskInformation> implements NodeExtension, TreeNode {
	@Getter @Setter
	@RDFSubject
	private String url;

	private final ValueFactory vf = SimpleValueFactory.getInstance();
	private static final Logger LOG = LoggerFactory.getLogger(IsSucceeding.class);
	...
	public Resource getType() {
	    return StandardBTVocabulary.IS_SUCCEEDING;
	}
	...
	public String toString() {
		return "IsSucceeding (" + url + " {" + child.toString() + "})";
	}
}
