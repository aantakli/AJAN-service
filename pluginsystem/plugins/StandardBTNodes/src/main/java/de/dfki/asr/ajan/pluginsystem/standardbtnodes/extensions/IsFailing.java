...
@Extension
@RDFBean("bt:IsFailing")
public class IsFailing extends AlwaysFail<AgentTaskInformation> implements NodeExtension, TreeNode {
	@Getter @Setter
	@RDFSubject
	private String url;

	private final ValueFactory vf = SimpleValueFactory.getInstance();
	private static final Logger LOG = LoggerFactory.getLogger(IsFailing.class);
	...
	public Resource getType() {
		return StandardBTVocabulary.IS_FAILING;
	}
