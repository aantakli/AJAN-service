 ...
 */
@DeepCopyState
public class OOInstance implements ObjectInstance {

	protected final String name;
	protected final String className;
	protected final HashMap<String, Object> variables;
	
	public OOInstance(String name, String className, HashMap<String, Object> variables) {
		this.name = name;
	...
	@Override
	public OOInstance copy() {
		return new OOInstance(new String(this.name), new String(this.className), (HashMap)variables.clone());
	}
