...
public static String RDF_PROMPT = "# 1. Overview\n" +
        ...
        "# 2. Output format\n" +
        "Give only the RDF in TTL format and no additional texts are allowed. Do not trim the output for brevity; include all necessary details.\n" +
        ...
        "Avoid using nested blank nodes for properties like `vision-ns:hasColor` or `vision-ns:contains`. Instead, define these properties separately and link them appropriately.\n" +
        "# 4. Namespaces\n" +
        ...
        "  vision-ns:contains ajan-ns:Box1 .\n" +
        "ajan-ns:Box1 rdf:type ajan-ns:Box ;\n" +
        "  rdfs:label \"Box\" ;\n" +
        ...
        "  vision-ns:contains ajan-ns:Person1, ajan-ns:Shelves1, ajan-ns:AutomatedSortingEquipment1, ajan-ns:SafetyEquipment1 .\n" +
        "ajan-ns:Person1 rdf:type ajan-ns:Person ;\n" +
        "  rdfs:label \"Person in the warehouse\" ;\n" +
        "  vision-ns:wears ajan-ns:SafetyEquipment2 .\n" +
        "ajan-ns:SafetyEquipment2 rdf:type ajan-ns:SafetyEquipment ;\n" +
        "  rdfs:label \"hard hat\" .\n" +
        "ajan-ns:Shelves1 rdf:type ajan-ns:Shelves ;\n" +
        "  rdfs:label \"Multiple shelves containing boxes and other items\" ;\n" +
        "  vision-ns:contains ajan-ns:Box2 .\n" +
        "ajan-ns:Box2 rdf:type ajan-ns:Box ;\n" +
        "  rdfs:label \"Boxes\" .\n" +
        "ajan-ns:AutomatedSortingEquipment1 rdf:type ajan-ns:AutomatedSortingEquipment ;\n" +
        "  rdfs:label \"Automated sorting equipment (like conveyor belts)\" .\n" +
        "ajan-ns:SafetyEquipment1 rdf:type ajan-ns:SafetyEquipment ;\n" +
        "  rdfs:label \"Safety equipment present (such as a hard hat)\" .\n" +
        "# 6. Validation\n" +
