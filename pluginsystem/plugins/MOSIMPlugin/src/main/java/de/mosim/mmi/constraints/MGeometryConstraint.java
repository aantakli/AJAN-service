...
public class MGeometryConstraint implements org.apache.thrift.TBase<MGeometryConstraint, MGeometryConstraint._Fields>, java.io.Serializable, Cloneable, Comparable<MGeometryConstraint> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MGeometryConstraint");
  ...
  private static final org.apache.thrift.protocol.TField TRANSLATION_CONSTRAINT_FIELD_DESC = new org.apache.thrift.protocol.TField("TranslationConstraint", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  private static final org.apache.thrift.protocol.TField ROTATION_CONSTRAINT_FIELD_DESC = new org.apache.thrift.protocol.TField("RotationConstraint", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MGeometryConstraintStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MGeometryConstraintTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable MTranslationConstraint TranslationConstraint; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TRANSLATION_CONSTRAINT((short)3, "TranslationConstraint"),
    ROTATION_CONSTRAINT((short)4, "RotationConstraint"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // TRANSLATION_CONSTRAINT
          return TRANSLATION_CONSTRAINT;
        case 4: // ROTATION_CONSTRAINT
  ...
  private static final _Fields optionals[] = {_Fields.PARENT_TO_CONSTRAINT,_Fields.TRANSLATION_CONSTRAINT,_Fields.ROTATION_CONSTRAINT,_Fields.WEIGHTING_FACTOR};
  ...
  static {
    ...
    tmpMap.put(_Fields.TRANSLATION_CONSTRAINT, new org.apache.thrift.meta_data.FieldMetaData("TranslationConstraint", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, MTranslationConstraint.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MGeometryConstraint.class, metaDataMap);
  }
   ...
   */
  public MGeometryConstraint(MGeometryConstraint other) {
    ...
    if (other.isSetTranslationConstraint()) {
      this.TranslationConstraint = new MTranslationConstraint(other.TranslationConstraint);
    }
  ...
  public MGeometryConstraint deepCopy() {
    return new MGeometryConstraint(this);
  }
  ...
  public void clear() {
    ...
    this.TranslationConstraint = null;
  ...
  public MGeometryConstraint setParentObjectID(@org.apache.thrift.annotation.Nullable java.lang.String ParentObjectID) {
    this.ParentObjectID = ParentObjectID;
    return this;
  }
  ...
  public MGeometryConstraint setParentToConstraint(@org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MTransform ParentToConstraint) {
  ...
  @org.apache.thrift.annotation.Nullable
  public MTranslationConstraint getTranslationConstraint() {
    return this.TranslationConstraint;
  }

  public MGeometryConstraint setTranslationConstraint(@org.apache.thrift.annotation.Nullable MTranslationConstraint TranslationConstraint) {
    this.TranslationConstraint = TranslationConstraint;
    return this;
  }

  public void unsetTranslationConstraint() {
    this.TranslationConstraint = null;
  }

  /** Returns true if field TranslationConstraint is set (has been assigned a value) and false otherwise */
  public boolean isSetTranslationConstraint() {
    return this.TranslationConstraint != null;
  }

  public void setTranslationConstraintIsSet(boolean value) {
    if (!value) {
      this.TranslationConstraint = null;
    }
  }
  ...
  public MGeometryConstraint setRotationConstraint(@org.apache.thrift.annotation.Nullable MRotationConstraint RotationConstraint) {
  ...
  public MGeometryConstraint setWeightingFactor(double WeightingFactor) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TRANSLATION_CONSTRAINT:
      if (value == null) {
        unsetTranslationConstraint();
      } else {
        setTranslationConstraint((MTranslationConstraint)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case TRANSLATION_CONSTRAINT:
      return getTranslationConstraint();
  ...
  public boolean isSet(_Fields field) {
    ...
    case TRANSLATION_CONSTRAINT:
      return isSetTranslationConstraint();
    case ROTATION_CONSTRAINT:
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof MGeometryConstraint)
      return this.equals((MGeometryConstraint)that);
    return false;
  }

  public boolean equals(MGeometryConstraint that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_TranslationConstraint = true && this.isSetTranslationConstraint();
    boolean that_present_TranslationConstraint = true && that.isSetTranslationConstraint();
    if (this_present_TranslationConstraint || that_present_TranslationConstraint) {
      if (!(this_present_TranslationConstraint && that_present_TranslationConstraint))
        return false;
      if (!this.TranslationConstraint.equals(that.TranslationConstraint))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetTranslationConstraint()) ? 131071 : 524287);
    if (isSetTranslationConstraint())
      hashCode = hashCode * 8191 + TranslationConstraint.hashCode();
  ...
  @Override
  public int compareTo(MGeometryConstraint other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTranslationConstraint()).compareTo(other.isSetTranslationConstraint());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTranslationConstraint()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.TranslationConstraint, other.TranslationConstraint);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("MGeometryConstraint(");
    boolean first = true;
    ...
    if (isSetTranslationConstraint()) {
      if (!first) sb.append(", ");
      sb.append("TranslationConstraint:");
      if (this.TranslationConstraint == null) {
        sb.append("null");
      } else {
        sb.append(this.TranslationConstraint);
      }
      first = false;
    }
    if (isSetRotationConstraint()) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (TranslationConstraint != null) {
      TranslationConstraint.validate();
    }
  ...
  private static class MGeometryConstraintStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MGeometryConstraintStandardScheme getScheme() {
      return new MGeometryConstraintStandardScheme();
    }
  }

  private static class MGeometryConstraintStandardScheme extends org.apache.thrift.scheme.StandardScheme<MGeometryConstraint> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MGeometryConstraint struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // TRANSLATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.TranslationConstraint = new MTranslationConstraint();
              struct.TranslationConstraint.read(iprot);
              struct.setTranslationConstraintIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MGeometryConstraint struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.TranslationConstraint != null) {
        if (struct.isSetTranslationConstraint()) {
          oprot.writeFieldBegin(TRANSLATION_CONSTRAINT_FIELD_DESC);
          struct.TranslationConstraint.write(oprot);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class MGeometryConstraintTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MGeometryConstraintTupleScheme getScheme() {
      return new MGeometryConstraintTupleScheme();
    }
  }

  private static class MGeometryConstraintTupleScheme extends org.apache.thrift.scheme.TupleScheme<MGeometryConstraint> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MGeometryConstraint struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MGeometryConstraint struct) throws org.apache.thrift.TException {
