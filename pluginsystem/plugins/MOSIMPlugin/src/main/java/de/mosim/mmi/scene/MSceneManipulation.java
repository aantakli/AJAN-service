            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Transforms = new java.util.ArrayList<MTransformManipulation>(_list184.size);
                @org.apache.thrift.annotation.Nullable MTransformManipulation _elem185;
                for (int _i186 = 0; _i186 < _list184.size; ++_i186)
                {
                  _elem185 = new MTransformManipulation();
                  _elem185.read(iprot);
                  struct.Transforms.add(_elem185);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.PhysicsInteractions = new java.util.ArrayList<MPhysicsInteraction>(_list187.size);
                @org.apache.thrift.annotation.Nullable MPhysicsInteraction _elem188;
                for (int _i189 = 0; _i189 < _list187.size; ++_i189)
                {
                  _elem188 = new MPhysicsInteraction();
                  _elem188.read(iprot);
                  struct.PhysicsInteractions.add(_elem188);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Properties = new java.util.ArrayList<MPropertyManipulation>(_list190.size);
                @org.apache.thrift.annotation.Nullable MPropertyManipulation _elem191;
                for (int _i192 = 0; _i192 < _list190.size; ++_i192)
                {
                  _elem191 = new MPropertyManipulation();
                  _elem191.read(iprot);
                  struct.Properties.add(_elem191);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Attachments = new java.util.ArrayList<MAttachmentManipulation>(_list193.size);
                @org.apache.thrift.annotation.Nullable MAttachmentManipulation _elem194;
                for (int _i195 = 0; _i195 < _list193.size; ++_i195)
                {
                  _elem194 = new MAttachmentManipulation();
                  _elem194.read(iprot);
                  struct.Attachments.add(_elem194);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.Transforms != null) {
        if (struct.isSetTransforms()) {
          oprot.writeFieldBegin(TRANSFORMS_FIELD_DESC);
          {
            ...
            for (MTransformManipulation _iter196 : struct.Transforms)
            {
      ...
      if (struct.PhysicsInteractions != null) {
        if (struct.isSetPhysicsInteractions()) {
          oprot.writeFieldBegin(PHYSICS_INTERACTIONS_FIELD_DESC);
          {
            ...
            for (MPhysicsInteraction _iter197 : struct.PhysicsInteractions)
            {
      ...
      if (struct.Properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (MPropertyManipulation _iter198 : struct.Properties)
            {
      ...
      if (struct.Attachments != null) {
        if (struct.isSetAttachments()) {
          oprot.writeFieldBegin(ATTACHMENTS_FIELD_DESC);
          {
            ...
            for (MAttachmentManipulation _iter199 : struct.Attachments)
            {
      ...
      if (struct.isSetTransforms()) {
        {
          ...
          for (MTransformManipulation _iter200 : struct.Transforms)
          {
      ...
      if (struct.isSetPhysicsInteractions()) {
        {
          ...
          for (MPhysicsInteraction _iter201 : struct.PhysicsInteractions)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (MPropertyManipulation _iter202 : struct.Properties)
          {
      ...
      if (struct.isSetAttachments()) {
        {
          ...
          for (MAttachmentManipulation _iter203 : struct.Attachments)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.Transforms = new java.util.ArrayList<MTransformManipulation>(_list204.size);
          @org.apache.thrift.annotation.Nullable MTransformManipulation _elem205;
          for (int _i206 = 0; _i206 < _list204.size; ++_i206)
          {
            _elem205 = new MTransformManipulation();
            _elem205.read(iprot);
            struct.Transforms.add(_elem205);
          }
        }
        struct.setTransformsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.PhysicsInteractions = new java.util.ArrayList<MPhysicsInteraction>(_list207.size);
          @org.apache.thrift.annotation.Nullable MPhysicsInteraction _elem208;
          for (int _i209 = 0; _i209 < _list207.size; ++_i209)
          {
            _elem208 = new MPhysicsInteraction();
            _elem208.read(iprot);
            struct.PhysicsInteractions.add(_elem208);
          }
        }
        struct.setPhysicsInteractionsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.Properties = new java.util.ArrayList<MPropertyManipulation>(_list210.size);
          @org.apache.thrift.annotation.Nullable MPropertyManipulation _elem211;
          for (int _i212 = 0; _i212 < _list210.size; ++_i212)
          {
            _elem211 = new MPropertyManipulation();
            _elem211.read(iprot);
            struct.Properties.add(_elem211);
          }
        }
        struct.setPropertiesIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.Attachments = new java.util.ArrayList<MAttachmentManipulation>(_list213.size);
          @org.apache.thrift.annotation.Nullable MAttachmentManipulation _elem214;
          for (int _i215 = 0; _i215 < _list213.size; ++_i215)
          {
            _elem214 = new MAttachmentManipulation();
            _elem214.read(iprot);
            struct.Attachments.add(_elem214);
          }
        }
        struct.setAttachmentsIsSet(true);
      }
