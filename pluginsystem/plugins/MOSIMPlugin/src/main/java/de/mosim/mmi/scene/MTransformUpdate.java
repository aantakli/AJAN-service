...
public class MTransformUpdate implements org.apache.thrift.TBase<MTransformUpdate, MTransformUpdate._Fields>, java.io.Serializable, Cloneable, Comparable<MTransformUpdate> {
  ...
  private static final org.apache.thrift.protocol.TField SCALE_FIELD_DESC = new org.apache.thrift.protocol.TField("Scale", org.apache.thrift.protocol.TType.LIST, (short)4);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> Scale; // optional
  ...
  private static final _Fields optionals[] = {_Fields.POSITION,_Fields.ROTATION,_Fields.PARENT,_Fields.SCALE};
  ...
  public MTransformUpdate(MTransformUpdate other) {
    ...
    if (other.isSetScale()) {
      java.util.List<java.lang.Double> __this__Scale = new java.util.ArrayList<java.lang.Double>(other.Scale);
      this.Scale = __this__Scale;
    }
  }
  ...
  public int getScaleSize() {
    return (this.Scale == null) ? 0 : this.Scale.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.Double> getScaleIterator() {
    return (this.Scale == null) ? null : this.Scale.iterator();
  }

  public void addToScale(double elem) {
    if (this.Scale == null) {
      this.Scale = new java.util.ArrayList<java.lang.Double>();
    }
    this.Scale.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.Double> getScale() {
    return this.Scale;
  }

  public MTransformUpdate setScale(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> Scale) {
    this.Scale = Scale;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SCALE:
      if (value == null) {
        ...
        setScale((java.util.List<java.lang.Double>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Scale = new java.util.ArrayList<java.lang.Double>(_list6.size);
                double _elem7;
                for (int _i8 = 0; _i8 < _list6.size; ++_i8)
                {
                  _elem7 = iprot.readDouble();
                  struct.Scale.add(_elem7);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MTransformUpdate struct) throws org.apache.thrift.TException {
      ...
      if (struct.Position != null) {
        if (struct.isSetPosition()) {
          oprot.writeFieldBegin(POSITION_FIELD_DESC);
          {
            ...
            for (double _iter9 : struct.Position)
            {
      ...
      if (struct.Rotation != null) {
        if (struct.isSetRotation()) {
          oprot.writeFieldBegin(ROTATION_FIELD_DESC);
          {
            ...
            for (double _iter10 : struct.Rotation)
            {
      ...
      if (struct.Scale != null) {
        if (struct.isSetScale()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.DOUBLE, struct.Scale.size()));
            for (double _iter11 : struct.Scale)
            {
  ...
  private static class MTransformUpdateTupleScheme extends org.apache.thrift.scheme.TupleScheme<MTransformUpdate> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, MTransformUpdate struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPosition()) {
        {
          ...
          for (double _iter12 : struct.Position)
          {
      ...
      if (struct.isSetRotation()) {
        {
          ...
          for (double _iter13 : struct.Rotation)
          {
      ...
      if (struct.isSetScale()) {
        {
          oprot.writeI32(struct.Scale.size());
          for (double _iter14 : struct.Scale)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.Position = new java.util.ArrayList<java.lang.Double>(_list15.size);
          double _elem16;
          for (int _i17 = 0; _i17 < _list15.size; ++_i17)
          {
            _elem16 = iprot.readDouble();
            struct.Position.add(_elem16);
          }
        }
        struct.setPositionIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.Rotation = new java.util.ArrayList<java.lang.Double>(_list18.size);
          double _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = iprot.readDouble();
            struct.Rotation.add(_elem19);
          }
        }
        struct.setRotationIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.Scale = new java.util.ArrayList<java.lang.Double>(_list21.size);
          double _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = iprot.readDouble();
            struct.Scale.add(_elem22);
          }
        }
        struct.setScaleIsSet(true);
      }
