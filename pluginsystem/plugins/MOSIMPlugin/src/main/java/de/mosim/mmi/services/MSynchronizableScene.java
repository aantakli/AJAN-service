              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.sceneManipulations = new java.util.ArrayList<de.mosim.mmi.scene.MSceneManipulation>(_list404.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.scene.MSceneManipulation _elem405;
                  for (int _i406 = 0; _i406 < _list404.size; ++_i406)
                  {
                    _elem405 = new de.mosim.mmi.scene.MSceneManipulation();
                    _elem405.read(iprot);
                    struct.sceneManipulations.add(_elem405);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, ApplyManipulations_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.sceneManipulations != null) {
          oprot.writeFieldBegin(SCENE_MANIPULATIONS_FIELD_DESC);
          {
            ...
            for (de.mosim.mmi.scene.MSceneManipulation _iter407 : struct.sceneManipulations)
            {
        ...
        if (struct.isSetSceneManipulations()) {
          {
            ...
            for (de.mosim.mmi.scene.MSceneManipulation _iter408 : struct.sceneManipulations)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.sceneManipulations = new java.util.ArrayList<de.mosim.mmi.scene.MSceneManipulation>(_list409.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.scene.MSceneManipulation _elem410;
            for (int _i411 = 0; _i411 < _list409.size; ++_i411)
            {
              _elem410 = new de.mosim.mmi.scene.MSceneManipulation();
              _elem410.read(iprot);
              struct.sceneManipulations.add(_elem410);
            }
          }
          struct.setSceneManipulationsIsSet(true);
        }
