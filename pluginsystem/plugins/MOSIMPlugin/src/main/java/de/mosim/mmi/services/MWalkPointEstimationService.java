              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.sceneObjects = new java.util.ArrayList<de.mosim.mmi.scene.MSceneObject>(_list306.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.scene.MSceneObject _elem307;
                  for (int _i308 = 0; _i308 < _list306.size; ++_i308)
                  {
                    _elem307 = new de.mosim.mmi.scene.MSceneObject();
                    _elem307.read(iprot);
                    struct.sceneObjects.add(_elem307);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map309.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, EstimateWalkPoints_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.sceneObjects != null) {
          oprot.writeFieldBegin(SCENE_OBJECTS_FIELD_DESC);
          {
            ...
            for (de.mosim.mmi.scene.MSceneObject _iter313 : struct.sceneObjects)
            {
        ...
        if (struct.properties != null) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter314 : struct.properties.entrySet())
            {
        ...
        if (struct.isSetSceneObjects()) {
          {
            ...
            for (de.mosim.mmi.scene.MSceneObject _iter315 : struct.sceneObjects)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.sceneObjects = new java.util.ArrayList<de.mosim.mmi.scene.MSceneObject>(_list317.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.scene.MSceneObject _elem318;
            for (int _i319 = 0; _i319 < _list317.size; ++_i319)
            {
              _elem318 = new de.mosim.mmi.scene.MSceneObject();
              _elem318.read(iprot);
              struct.sceneObjects.add(_elem318);
            }
          }
          struct.setSceneObjectsIsSet(true);
        }
        ...
        if (incoming.get(3)) {
          {
            ...
            struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map320.size);
            ...
            for (int _i323 = 0; _i323 < _map320.size; ++_i323)
            {
              ...
              struct.properties.put(_key321, _val322);
            }
          }
          struct.setPropertiesIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<MWalkPoint>(_list324.size);
                  @org.apache.thrift.annotation.Nullable MWalkPoint _elem325;
                  for (int _i326 = 0; _i326 < _list324.size; ++_i326)
                  {
                    _elem325 = new MWalkPoint();
                    _elem325.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, EstimateWalkPoints_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (MWalkPoint _iter327 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (MWalkPoint _iter328 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<MWalkPoint>(_list329.size);
            @org.apache.thrift.annotation.Nullable MWalkPoint _elem330;
            for (int _i331 = 0; _i331 < _list329.size; ++_i331)
            {
              _elem330 = new MWalkPoint();
              _elem330.read(iprot);
