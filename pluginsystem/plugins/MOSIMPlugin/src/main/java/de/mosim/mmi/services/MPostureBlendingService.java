...
public class MPostureBlendingService {
  ...
  public interface Iface extends MMIServiceBase.Iface {
    ...
    public de.mosim.mmi.avatar.MAvatarPostureValues Blend(de.mosim.mmi.avatar.MAvatarPostureValues startPosture, de.mosim.mmi.avatar.MAvatarPostureValues targetPosture, double weight, java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask, java.util.Map<java.lang.String,java.lang.String> properties) throws org.apache.thrift.TException;

    public java.util.List<de.mosim.mmi.avatar.MAvatarPostureValues> BlendMany(de.mosim.mmi.avatar.MAvatarPostureValues startPosture, de.mosim.mmi.avatar.MAvatarPostureValues targetPosture, java.util.List<java.lang.Double> weights, java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask, java.util.Map<java.lang.String,java.lang.String> properties) throws org.apache.thrift.TException;

  }

  public interface AsyncIface extends MMIServiceBase .AsyncIface {

    public void Blend(de.mosim.mmi.avatar.MAvatarPostureValues startPosture, de.mosim.mmi.avatar.MAvatarPostureValues targetPosture, double weight, java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask, java.util.Map<java.lang.String,java.lang.String> properties, org.apache.thrift.async.AsyncMethodCallback<de.mosim.mmi.avatar.MAvatarPostureValues> resultHandler) throws org.apache.thrift.TException;

    public void BlendMany(de.mosim.mmi.avatar.MAvatarPostureValues startPosture, de.mosim.mmi.avatar.MAvatarPostureValues targetPosture, java.util.List<java.lang.Double> weights, java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask, java.util.Map<java.lang.String,java.lang.String> properties, org.apache.thrift.async.AsyncMethodCallback<java.util.List<de.mosim.mmi.avatar.MAvatarPostureValues>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends MMIServiceBase.AsyncClient implements AsyncIface {
    ...
    public static class Blend_call extends org.apache.thrift.async.TAsyncMethodCall<de.mosim.mmi.avatar.MAvatarPostureValues> {
      ...
      private java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask;
  ...
  public static class Blend_args implements org.apache.thrift.TBase<Blend_args, Blend_args._Fields>, java.io.Serializable, Cloneable, Comparable<Blend_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask; // required
    ...
    public Blend_args(
      ...
      double weight,
      java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask,
    ...
    public Blend_args(Blend_args other) {
      ...
      if (other.isSetMask()) {
        java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> __this__mask = new java.util.HashMap<de.mosim.mmi.math.MTransform,java.lang.Double>(other.mask.size());
        for (java.util.Map.Entry<de.mosim.mmi.math.MTransform, java.lang.Double> other_element : other.mask.entrySet()) {

          de.mosim.mmi.math.MTransform other_element_key = other_element.getKey();
          java.lang.Double other_element_value = other_element.getValue();

          de.mosim.mmi.math.MTransform __this__mask_copy_key = new de.mosim.mmi.math.MTransform(other_element_key);
    ...
    public void putToMask(de.mosim.mmi.math.MTransform key, double val) {
      if (this.mask == null) {
        this.mask = new java.util.HashMap<de.mosim.mmi.math.MTransform,java.lang.Double>();
      }
      this.mask.put(key, val);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> getMask() {
      return this.mask;
    }

    public Blend_args setMask(@org.apache.thrift.annotation.Nullable java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask) {
      this.mask = mask;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case MASK:
        if (value == null) {
          ...
          setMask((java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double>)value);
        }
        break;
    ...
    private static class Blend_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<Blend_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.mask = new java.util.HashMap<de.mosim.mmi.math.MTransform,java.lang.Double>(2*_map216.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MTransform _key217;
                  double _val218;
                  for (int _i219 = 0; _i219 < _map216.size; ++_i219)
                  {
                    _key217 = new de.mosim.mmi.math.MTransform();
                    _key217.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, Blend_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.mask != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.DOUBLE, struct.mask.size()));
            for (java.util.Map.Entry<de.mosim.mmi.math.MTransform, java.lang.Double> _iter224 : struct.mask.entrySet())
            {
        ...
        if (struct.isSetMask()) {
          {
            ...
            for (java.util.Map.Entry<de.mosim.mmi.math.MTransform, java.lang.Double> _iter226 : struct.mask.entrySet())
            {
              _iter226.getKey().write(oprot);
        ...
        if (incoming.get(3)) {
          {
            ...
            struct.mask = new java.util.HashMap<de.mosim.mmi.math.MTransform,java.lang.Double>(2*_map228.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MTransform _key229;
            double _val230;
            for (int _i231 = 0; _i231 < _map228.size; ++_i231)
            {
              _key229 = new de.mosim.mmi.math.MTransform();
              _key229.read(iprot);
  ...
  public static class BlendMany_args implements org.apache.thrift.TBase<BlendMany_args, BlendMany_args._Fields>, java.io.Serializable, Cloneable, Comparable<BlendMany_args>   {
    ...
    public BlendMany_args setMask(@org.apache.thrift.annotation.Nullable java.util.Map<de.mosim.mmi.math.MTransform,java.lang.Double> mask) {
      this.mask = mask;
      return this;
    }
    ...
    private static class BlendMany_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<BlendMany_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.mask = new java.util.HashMap<de.mosim.mmi.math.MTransform,java.lang.Double>(2*_map239.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MTransform _key240;
                  double _val241;
                  for (int _i242 = 0; _i242 < _map239.size; ++_i242)
                  {
                    _key240 = new de.mosim.mmi.math.MTransform();
                    _key240.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, BlendMany_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.mask != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.DOUBLE, struct.mask.size()));
            for (java.util.Map.Entry<de.mosim.mmi.math.MTransform, java.lang.Double> _iter248 : struct.mask.entrySet())
            {
    ...
    private static class BlendMany_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<BlendMany_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, BlendMany_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetMask()) {
          {
            oprot.writeI32(struct.mask.size());
            for (java.util.Map.Entry<de.mosim.mmi.math.MTransform, java.lang.Double> _iter251 : struct.mask.entrySet())
            {
        ...
        if (incoming.get(3)) {
          {
            ...
            struct.mask = new java.util.HashMap<de.mosim.mmi.math.MTransform,java.lang.Double>(2*_map256.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MTransform _key257;
            double _val258;
            for (int _i259 = 0; _i259 < _map256.size; ++_i259)
            {
              _key257 = new de.mosim.mmi.math.MTransform();
              _key257.read(iprot);
