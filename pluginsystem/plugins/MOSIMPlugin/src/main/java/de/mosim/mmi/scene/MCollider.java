            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Colliders = new java.util.ArrayList<MCollider>(_list216.size);
                @org.apache.thrift.annotation.Nullable MCollider _elem217;
                for (int _i218 = 0; _i218 < _list216.size; ++_i218)
                {
                  _elem217 = new MCollider();
                  _elem217.read(iprot);
                  struct.Colliders.add(_elem217);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.Colliders != null) {
        if (struct.isSetColliders()) {
          oprot.writeFieldBegin(COLLIDERS_FIELD_DESC);
          {
            ...
            for (MCollider _iter223 : struct.Colliders)
            {
      ...
      if (struct.Properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter224 : struct.Properties.entrySet())
            {
      ...
      if (struct.isSetColliders()) {
        {
          ...
          for (MCollider _iter225 : struct.Colliders)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter226 : struct.Properties.entrySet())
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.Colliders = new java.util.ArrayList<MCollider>(_list227.size);
          @org.apache.thrift.annotation.Nullable MCollider _elem228;
          for (int _i229 = 0; _i229 < _list227.size; ++_i229)
          {
            _elem228 = new MCollider();
            _elem228.read(iprot);
            struct.Colliders.add(_elem228);
          }
        }
        struct.setCollidersIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.Properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map230.size);
          ...
          for (int _i233 = 0; _i233 < _map230.size; ++_i233)
          {
            ...
            struct.Properties.put(_key231, _val232);
          }
        }
        struct.setPropertiesIsSet(true);
      }
