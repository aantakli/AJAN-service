              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.joints = new java.util.ArrayList<de.mosim.mmi.avatar.MJointType>(_list342.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.avatar.MJointType _elem343;
                  for (int _i344 = 0; _i344 < _list342.size; ++_i344)
                  {
                    _elem343 = de.mosim.mmi.avatar.MJointType.findByValue(iprot.readI32());
                    if (_elem343 != null)
                    {
                      struct.joints.add(_elem343);
                    }
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, SetAnimatedJoints_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.joints != null) {
          oprot.writeFieldBegin(JOINTS_FIELD_DESC);
          {
            ...
            for (de.mosim.mmi.avatar.MJointType _iter345 : struct.joints)
            {
              oprot.writeI32(_iter345.getValue());
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
        ...
        if (struct.isSetJoints()) {
          {
            ...
            for (de.mosim.mmi.avatar.MJointType _iter346 : struct.joints)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.joints = new java.util.ArrayList<de.mosim.mmi.avatar.MJointType>(_list347.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.avatar.MJointType _elem348;
            for (int _i349 = 0; _i349 < _list347.size; ++_i349)
            {
              _elem348 = de.mosim.mmi.avatar.MJointType.findByValue(iprot.readI32());
              if (_elem348 != null)
              {
                struct.joints.add(_elem348);
              }
            }
          }
          struct.setJointsIsSet(true);
    ...
    private static class GetCurrentPostureValuesPartial_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<GetCurrentPostureValuesPartial_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.joints = new java.util.ArrayList<de.mosim.mmi.avatar.MJointType>(_list350.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.avatar.MJointType _elem351;
                  for (int _i352 = 0; _i352 < _list350.size; ++_i352)
                  {
                    _elem351 = de.mosim.mmi.avatar.MJointType.findByValue(iprot.readI32());
                    if (_elem351 != null)
                    {
                      struct.joints.add(_elem351);
                    }
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, GetCurrentPostureValuesPartial_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.joints != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, struct.joints.size()));
            for (de.mosim.mmi.avatar.MJointType _iter353 : struct.joints)
            {
              oprot.writeI32(_iter353.getValue());
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
    ...
    private static class GetCurrentPostureValuesPartial_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetCurrentPostureValuesPartial_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, GetCurrentPostureValuesPartial_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetJoints()) {
          {
            oprot.writeI32(struct.joints.size());
            for (de.mosim.mmi.avatar.MJointType _iter354 : struct.joints)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.joints = new java.util.ArrayList<de.mosim.mmi.avatar.MJointType>(_list355.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.avatar.MJointType _elem356;
            for (int _i357 = 0; _i357 < _list355.size; ++_i357)
            {
              _elem356 = de.mosim.mmi.avatar.MJointType.findByValue(iprot.readI32());
              if (_elem356 != null)
              {
                struct.joints.add(_elem356);
              }
            }
          }
          struct.setJointsIsSet(true);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<de.mosim.mmi.math.MVector3>(_list358.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MVector3 _elem359;
                  for (int _i360 = 0; _i360 < _list358.size; ++_i360)
                  {
                    _elem359 = new de.mosim.mmi.math.MVector3();
                    _elem359.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, GetCurrentJointPositions_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (de.mosim.mmi.math.MVector3 _iter361 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (de.mosim.mmi.math.MVector3 _iter362 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<de.mosim.mmi.math.MVector3>(_list363.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MVector3 _elem364;
            for (int _i365 = 0; _i365 < _list363.size; ++_i365)
            {
              _elem364 = new de.mosim.mmi.math.MVector3();
              _elem364.read(iprot);
