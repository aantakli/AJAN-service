    ...
    private static class GetCurrentPostureValuesPartial_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<GetCurrentPostureValuesPartial_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.joints = new java.util.ArrayList<de.mosim.mmi.avatar.MJointType>(_list340.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.avatar.MJointType _elem341;
                  for (int _i342 = 0; _i342 < _list340.size; ++_i342)
                  {
                    _elem341 = de.mosim.mmi.avatar.MJointType.findByValue(iprot.readI32());
                    if (_elem341 != null)
                    {
                      struct.joints.add(_elem341);
                    }
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, GetCurrentPostureValuesPartial_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.joints != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, struct.joints.size()));
            for (de.mosim.mmi.avatar.MJointType _iter343 : struct.joints)
            {
    ...
    private static class GetCurrentPostureValuesPartial_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetCurrentPostureValuesPartial_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, GetCurrentPostureValuesPartial_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetJoints()) {
          {
            oprot.writeI32(struct.joints.size());
            for (de.mosim.mmi.avatar.MJointType _iter344 : struct.joints)
            {
              oprot.writeI32(_iter344.getValue());
            }
          }
        }
      }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.joints = new java.util.ArrayList<de.mosim.mmi.avatar.MJointType>(_list345.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.avatar.MJointType _elem346;
            for (int _i347 = 0; _i347 < _list345.size; ++_i347)
            {
              _elem346 = de.mosim.mmi.avatar.MJointType.findByValue(iprot.readI32());
              if (_elem346 != null)
              {
                struct.joints.add(_elem346);
              }
            }
          }
          struct.setJointsIsSet(true);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<de.mosim.mmi.math.MVector3>(_list348.size);
                  @org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MVector3 _elem349;
                  for (int _i350 = 0; _i350 < _list348.size; ++_i350)
                  {
                    _elem349 = new de.mosim.mmi.math.MVector3();
                    _elem349.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, GetCurrentJointPositions_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (de.mosim.mmi.math.MVector3 _iter351 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (de.mosim.mmi.math.MVector3 _iter352 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<de.mosim.mmi.math.MVector3>(_list353.size);
            @org.apache.thrift.annotation.Nullable de.mosim.mmi.math.MVector3 _elem354;
            for (int _i355 = 0; _i355 < _list353.size; ++_i355)
            {
              _elem354 = new de.mosim.mmi.math.MVector3();
              _elem354.read(iprot);
