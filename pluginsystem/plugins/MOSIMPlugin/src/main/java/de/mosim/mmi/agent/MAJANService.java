...
public class MAJANService {
  ...
  public interface Iface {
    ...
    public java.lang.String CreateAgent(java.lang.String name, java.lang.String templateAgent, MRDFGraph knowledge) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void CreateAgent(java.lang.String name, java.lang.String templateAgent, MRDFGraph knowledge, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_CreateAgent(java.lang.String name, java.lang.String templateAgent, MRDFGraph knowledge) throws org.apache.thrift.TException
    {
      CreateAgent_args args = new CreateAgent_args();
      args.setName(name);
      args.setTemplateAgent(templateAgent);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void CreateAgent(java.lang.String name, java.lang.String templateAgent, MRDFGraph knowledge, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      CreateAgent_call method_call = new CreateAgent_call(name, templateAgent, knowledge, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class CreateAgent_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.String> {
      ...
      private java.lang.String templateAgent;
      private MRDFGraph knowledge;
      public CreateAgent_call(java.lang.String name, java.lang.String templateAgent, MRDFGraph knowledge, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class CreateAgent<I extends Iface> extends org.apache.thrift.ProcessFunction<I, CreateAgent_args> {
      ...
      public CreateAgent_result getResult(I iface, CreateAgent_args args) throws org.apache.thrift.TException {
        CreateAgent_result result = new CreateAgent_result();
        result.success = iface.CreateAgent(args.name, args.templateAgent, args.knowledge);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class CreateAgent<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, CreateAgent_args, java.lang.String> {
      ...
      public void start(I iface, CreateAgent_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
        iface.CreateAgent(args.name, args.templateAgent, args.knowledge,resultHandler);
      }
    }
  ...
  public static class CreateAgent_args implements org.apache.thrift.TBase<CreateAgent_args, CreateAgent_args._Fields>, java.io.Serializable, Cloneable, Comparable<CreateAgent_args>   {
    ...
    private static final org.apache.thrift.protocol.TField TEMPLATE_AGENT_FIELD_DESC = new org.apache.thrift.protocol.TField("templateAgent", org.apache.thrift.protocol.TType.STRING, (short)2);
    ...
    public @org.apache.thrift.annotation.Nullable java.lang.String templateAgent; // required
    public @org.apache.thrift.annotation.Nullable MRDFGraph knowledge; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      NAME((short)1, "name"),
      TEMPLATE_AGENT((short)2, "templateAgent"),
    ...
    static {
      ...
      tmpMap.put(_Fields.TEMPLATE_AGENT, new org.apache.thrift.meta_data.FieldMetaData("templateAgent", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public CreateAgent_args(
      ...
      java.lang.String templateAgent,
      MRDFGraph knowledge)
    {
      this();
      this.name = name;
    ...
    public CreateAgent_args(CreateAgent_args other) {
      ...
      if (other.isSetTemplateAgent()) {
        this.templateAgent = other.templateAgent;
      }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.lang.String getTemplateAgent() {
      return this.templateAgent;
    }

    public CreateAgent_args setTemplateAgent(@org.apache.thrift.annotation.Nullable java.lang.String templateAgent) {
      this.templateAgent = templateAgent;
      return this;
    }

    public void unsetTemplateAgent() {
      this.templateAgent = null;
    }

    /** Returns true if field templateAgent is set (has been assigned a value) and false otherwise */
    public boolean isSetTemplateAgent() {
      return this.templateAgent != null;
    }

    public void setTemplateAgentIsSet(boolean value) {
      if (!value) {
        this.templateAgent = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case TEMPLATE_AGENT:
        if (value == null) {
          ...
          setTemplateAgent((java.lang.String)value);
        }
        break;
    ...
    public boolean equals(CreateAgent_args that) {
      ...
      boolean this_present_templateAgent = true && this.isSetTemplateAgent();
      boolean that_present_templateAgent = true && that.isSetTemplateAgent();
      if (this_present_templateAgent || that_present_templateAgent) {
        if (!(this_present_templateAgent && that_present_templateAgent))
          return false;
        if (!this.templateAgent.equals(that.templateAgent))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetTemplateAgent()) ? 131071 : 524287);
      if (isSetTemplateAgent())
        hashCode = hashCode * 8191 + templateAgent.hashCode();
    ...
    public int compareTo(CreateAgent_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetTemplateAgent()).compareTo(other.isSetTemplateAgent());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetTemplateAgent()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.templateAgent, other.templateAgent);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("templateAgent:");
      if (this.templateAgent == null) {
        sb.append("null");
      } else {
        sb.append(this.templateAgent);
      }
      first = false;
      if (!first) sb.append(", ");
      sb.append("knowledge:");
    ...
    private static class CreateAgent_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<CreateAgent_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, CreateAgent_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // TEMPLATE_AGENT
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.templateAgent = iprot.readString();
                struct.setTemplateAgentIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, CreateAgent_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.templateAgent != null) {
          oprot.writeFieldBegin(TEMPLATE_AGENT_FIELD_DESC);
          oprot.writeString(struct.templateAgent);
          oprot.writeFieldEnd();
        }
