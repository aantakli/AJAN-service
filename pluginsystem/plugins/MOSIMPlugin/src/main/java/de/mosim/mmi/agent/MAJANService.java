...
public class MAJANService {
  ...
  public interface Iface {
    ...
    public java.lang.String CreateAgent(java.lang.String name, java.lang.String agentTemplate, MRDFGraph knowledge) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void CreateAgent(java.lang.String name, java.lang.String agentTemplate, MRDFGraph knowledge, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public java.lang.String CreateAgent(java.lang.String name, java.lang.String agentTemplate, MRDFGraph knowledge) throws org.apache.thrift.TException
    {
      send_CreateAgent(name, agentTemplate, knowledge);
      return recv_CreateAgent();
    }

    public void send_CreateAgent(java.lang.String name, java.lang.String agentTemplate, MRDFGraph knowledge) throws org.apache.thrift.TException
    {
      CreateAgent_args args = new CreateAgent_args();
      args.setName(name);
      args.setAgentTemplate(agentTemplate);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void CreateAgent(java.lang.String name, java.lang.String agentTemplate, MRDFGraph knowledge, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      CreateAgent_call method_call = new CreateAgent_call(name, agentTemplate, knowledge, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class CreateAgent_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.String> {
      ...
      private java.lang.String agentTemplate;
      private MRDFGraph knowledge;
      public CreateAgent_call(java.lang.String name, java.lang.String agentTemplate, MRDFGraph knowledge, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class CreateAgent<I extends Iface> extends org.apache.thrift.ProcessFunction<I, CreateAgent_args> {
      ...
      public CreateAgent_result getResult(I iface, CreateAgent_args args) throws org.apache.thrift.TException {
        CreateAgent_result result = new CreateAgent_result();
        result.success = iface.CreateAgent(args.name, args.agentTemplate, args.knowledge);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class CreateAgent<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, CreateAgent_args, java.lang.String> {
      ...
      public void start(I iface, CreateAgent_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
        iface.CreateAgent(args.name, args.agentTemplate, args.knowledge,resultHandler);
      }
    }
  ...
  public static class CreateAgent_args implements org.apache.thrift.TBase<CreateAgent_args, CreateAgent_args._Fields>, java.io.Serializable, Cloneable, Comparable<CreateAgent_args>   {
    ...
    private static final org.apache.thrift.protocol.TField AGENT_TEMPLATE_FIELD_DESC = new org.apache.thrift.protocol.TField("agentTemplate", org.apache.thrift.protocol.TType.STRING, (short)2);
    ...
    public @org.apache.thrift.annotation.Nullable java.lang.String agentTemplate; // required
    public @org.apache.thrift.annotation.Nullable MRDFGraph knowledge; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      NAME((short)1, "name"),
      AGENT_TEMPLATE((short)2, "agentTemplate"),
    ...
    static {
      ...
      tmpMap.put(_Fields.AGENT_TEMPLATE, new org.apache.thrift.meta_data.FieldMetaData("agentTemplate", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public CreateAgent_args(
      ...
      java.lang.String agentTemplate,
      MRDFGraph knowledge)
    {
      this();
      this.name = name;
    ...
    public CreateAgent_args(CreateAgent_args other) {
      ...
      if (other.isSetAgentTemplate()) {
        this.agentTemplate = other.agentTemplate;
      }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.lang.String getAgentTemplate() {
      return this.agentTemplate;
    }

    public CreateAgent_args setAgentTemplate(@org.apache.thrift.annotation.Nullable java.lang.String agentTemplate) {
      this.agentTemplate = agentTemplate;
      return this;
    }

    public void unsetAgentTemplate() {
      this.agentTemplate = null;
    }

    /** Returns true if field agentTemplate is set (has been assigned a value) and false otherwise */
    public boolean isSetAgentTemplate() {
      return this.agentTemplate != null;
    }

    public void setAgentTemplateIsSet(boolean value) {
      if (!value) {
        this.agentTemplate = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case AGENT_TEMPLATE:
        if (value == null) {
          ...
          setAgentTemplate((java.lang.String)value);
        }
        break;
    ...
    public boolean equals(CreateAgent_args that) {
      ...
      boolean this_present_agentTemplate = true && this.isSetAgentTemplate();
      boolean that_present_agentTemplate = true && that.isSetAgentTemplate();
      if (this_present_agentTemplate || that_present_agentTemplate) {
        if (!(this_present_agentTemplate && that_present_agentTemplate))
          return false;
        if (!this.agentTemplate.equals(that.agentTemplate))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetAgentTemplate()) ? 131071 : 524287);
      if (isSetAgentTemplate())
        hashCode = hashCode * 8191 + agentTemplate.hashCode();
    ...
    public int compareTo(CreateAgent_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetAgentTemplate()).compareTo(other.isSetAgentTemplate());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetAgentTemplate()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.agentTemplate, other.agentTemplate);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("agentTemplate:");
      if (this.agentTemplate == null) {
        sb.append("null");
      } else {
        sb.append(this.agentTemplate);
      }
      first = false;
      if (!first) sb.append(", ");
      sb.append("knowledge:");
    ...
    private static class CreateAgent_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<CreateAgent_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, CreateAgent_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // AGENT_TEMPLATE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.agentTemplate = iprot.readString();
                struct.setAgentTemplateIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, CreateAgent_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.agentTemplate != null) {
          oprot.writeFieldBegin(AGENT_TEMPLATE_FIELD_DESC);
          oprot.writeString(struct.agentTemplate);
          oprot.writeFieldEnd();
        }
