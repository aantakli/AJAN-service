...
* `-Dtriplestore.initialData.agentFolderPath=executionservice/use-case/agents` -> Folder for predefined agents model (RDF/Trig)
* `-Dtriplestore.initialData.domainFolderPath=executionservice/use-case/domains` -> Folder for predefined domain model (RDF/Turtle)
* `-Dtriplestore.initialData.serviceFolderPath=executionservice/use-case/services` -> Folder for predefined services model (RDF/Turtle)
* `-Dtriplestore.initialData.behaviorsFolderPath=executionservice/use-case/behaviors` -> Folder for predefined behaviors model (RDF/Turtle)
