...
- Vorhanden: `boot4-resteasy` (Spike B: RESTEasy-Spring-Boot-Starter unter Boot 4), `pf4j-java21` (Spike D: pf4j aktuell + Fat-JAR-Resolution unter JDK 21), `etappe3-query-equivalence` (Task-3-Differentialharness OLD/ROUND1/NEW fuer die SailQueryPreparer-Ablösung; Ergebnis vor dem RDF4J-5.3.1-Flip unwiederholbar festgehalten in `etappe3-query-equivalence/PRE-FLIP-RESULT.md`), `rdf4j5-boot13` (Gate E: RDF4J-5.3.1-Client-Probe unter Spring Boot 1.3.5 / Java 11, fuenf Beine inkl. erzwungenem SPARQL-Results-JSON-Pfad).
