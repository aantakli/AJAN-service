...
@Component
public class RDFProducer extends ModelProducer implements MessageBodyWriter<Model> {
	...
	@Override
	public long getSize(final Model t, final Class<?> type, final Type type1, final Annotation[] antns, final MediaType mt) {
	...
	public void writeTo(final Model t, final Class<?> type, final Type type1, final Annotation[] antns, final MediaType mt, final MultivaluedMap<String, Object> mm, final OutputStream out) throws IOException, WebApplicationException {
		writeModel(t, mt, out);
	}
}
